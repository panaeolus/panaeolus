...
instr 1
  ...
  a5	linen		1250, iattack, p3, (p3*.1)			;amp envelope

  a21 line	456, imorph, 1030					; imorph morph-time,0=instant aah
  a5	linen 10000, iattack, p3, (p3*.1)			;amp envelope
